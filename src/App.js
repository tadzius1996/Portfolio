...
function App() {
  ...
  return (
    ...
    <div className='mainContainer'>
      ...
      <p className='pre-title' data-aos='fade-right'>Hello, my name is</p>
      <h2 data-aos='fade-in' className='title' data-aos='fade-right'><br/>Tadas <span className='title-span' data-aos='fade-right'>and I develop the internet</span></h2>
