    ...
    return (
        ...
        <div className='aboutContainer' data-aos='fade-up'>
            ...
            <ul className='aboutList'>
                ...
                <li className='aboutItem aboutItemLast'>Javascript</li>
            </ul>
            <img src='/about.jpg' className='imagee2' />
            <div className='about-layoverr'></div>
            </div>
            <img src='/planets.png' className='planets'/>
            <img src='/stars2.png' className='shooting2'/>
            <img src='/shooting.png' className='shooting3'/>
            <img src='/stars2.png' className='shooting5'/>
